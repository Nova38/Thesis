...
/**
  ...
  *
  * @checksum - 5d8f203a5023778e53001539d7e31a7dfd75c1aea16d015f6eda31bcc6a2612d
  * @variables - radius=rounded-lg,accentColor=cyan,colorTemperature=neutral,spacing=1.5,scale=sm,inputShadow=shadow,baseColorShade=600,borderShadeLightMode=400,borderShadeDarkMode=500,inputMaxWidth=max-w-[20em],tagRadius=rounded,swatchRadius=rounded
  * @theme - regenesis
  **/
