...
var ReferenceListByTypeRequest = proto3.makeMessageType(
  "auth.common.ReferenceListByTypeRequest",
  () => [
    {
      no: 1,
      name: "bookmark",
...
var ReferenceListByTypeResponse = proto3.makeMessageType(
  "auth.common.ReferenceListByTypeResponse",
  () => [
    {
      no: 1,
      name: "bookmark",
