...
var Any = class _Any extends Message {
  ...
  unpack(registry2) {
    ...
    const messageType = registry2.findMessage(this.typeUrlToName(this.typeUrl));
    if (!messageType) {
      return void 0;
    }
...
var TransactionType = /* @__PURE__ */ ((TransactionType3) => {
  TransactionType3[TransactionType3["UNSPECIFIED"] = 0] = "UNSPECIFIED";
  TransactionType3[TransactionType3["INVOKE"] = 1] = "INVOKE";
  TransactionType3[TransactionType3["QUERY"] = 2] = "QUERY";
...
var ObjectKind = /* @__PURE__ */ ((ObjectKind3) => {
  ObjectKind3[ObjectKind3["UNSPECIFIED"] = 0] = "UNSPECIFIED";
  ObjectKind3[ObjectKind3["GLOBAL_OBJECT"] = 1] = "GLOBAL_OBJECT";
  ObjectKind3[ObjectKind3["PRIMARY_OBJECT"] = 2] = "PRIMARY_OBJECT";
  ObjectKind3[ObjectKind3["SUB_OBJECT"] = 3] = "SUB_OBJECT";
  ObjectKind3[ObjectKind3["REFERENCE"] = 4] = "REFERENCE";
  return ObjectKind3;
})(ObjectKind || {});
...
var Action = /* @__PURE__ */ ((Action3) => {
  Action3[Action3["UNSPECIFIED"] = 0] = "UNSPECIFIED";
  Action3[Action3["UTILITY"] = 1] = "UTILITY";
  Action3[Action3["VIEW"] = 10] = "VIEW";
  Action3[Action3["CREATE"] = 11] = "CREATE";
  Action3[Action3["UPDATE"] = 12] = "UPDATE";
  Action3[Action3["DELETE"] = 13] = "DELETE";
  Action3[Action3["SUGGEST_VIEW"] = 14] = "SUGGEST_VIEW";
  Action3[Action3["SUGGEST_CREATE"] = 15] = "SUGGEST_CREATE";
  Action3[Action3["SUGGEST_DELETE"] = 16] = "SUGGEST_DELETE";
  Action3[Action3["SUGGEST_APPROVE"] = 17] = "SUGGEST_APPROVE";
  Action3[Action3["VIEW_HISTORY"] = 18] = "VIEW_HISTORY";
  Action3[Action3["VIEW_HIDDEN_TXS"] = 19] = "VIEW_HIDDEN_TXS";
  Action3[Action3["HIDE_TX"] = 20] = "HIDE_TX";
  Action3[Action3["REFERENCE_CREATE"] = 21] = "REFERENCE_CREATE";
  Action3[Action3["REFERENCE_DELETE"] = 22] = "REFERENCE_DELETE";
  Action3[Action3["REFERENCE_VIEW"] = 23] = "REFERENCE_VIEW";
  return Action3;
})(Action || {});
...
var TxError = /* @__PURE__ */ ((TxError3) => {
  TxError3[TxError3["UNSPECIFIED"] = 0] = "UNSPECIFIED";
  TxError3[TxError3["REQUEST_INVALID"] = 1] = "REQUEST_INVALID";
  TxError3[TxError3["RUNTIME"] = 2] = "RUNTIME";
  TxError3[TxError3["RUNTIME_BAD_OPS"] = 3] = "RUNTIME_BAD_OPS";
  TxError3[TxError3["KEY_NOT_FOUND"] = 4] = "KEY_NOT_FOUND";
  TxError3[TxError3["KEY_ALREADY_EXISTS"] = 5] = "KEY_ALREADY_EXISTS";
  TxError3[TxError3["COLLECTION_INVALID_ID"] = 11] = "COLLECTION_INVALID_ID";
  TxError3[TxError3["COLLECTION_UNREGISTERED"] = 12] = "COLLECTION_UNREGISTERED";
  TxError3[TxError3["COLLECTION_ALREADY_REGISTERED"] = 13] = "COLLECTION_ALREADY_REGISTERED";
  TxError3[TxError3["COLLECTION_INVALID"] = 14] = "COLLECTION_INVALID";
  TxError3[TxError3["COLLECTION_INVALID_OBJECT_TYPE"] = 15] = "COLLECTION_INVALID_OBJECT_TYPE";
  TxError3[TxError3["COLLECTION_INVALID_ROLE_ID"] = 16] = "COLLECTION_INVALID_ROLE_ID";
  TxError3[TxError3["USER_INVALID_ID"] = 20] = "USER_INVALID_ID";
  TxError3[TxError3["USER_UNREGISTERED"] = 21] = "USER_UNREGISTERED";
  TxError3[TxError3["USER_ALREADY_REGISTERED"] = 22] = "USER_ALREADY_REGISTERED";
  TxError3[TxError3["USER_INVALID"] = 23] = "USER_INVALID";
  TxError3[TxError3["USER_NO_ROLE"] = 24] = "USER_NO_ROLE";
  TxError3[TxError3["USER_PERMISSION_DENIED"] = 26] = "USER_PERMISSION_DENIED";
  TxError3[TxError3["OBJECT_INVALID_ID"] = 31] = "OBJECT_INVALID_ID";
  TxError3[TxError3["OBJECT_UNREGISTERED"] = 32] = "OBJECT_UNREGISTERED";
  TxError3[TxError3["OBJECT_ALREADY_REGISTERED"] = 33] = "OBJECT_ALREADY_REGISTERED";
  TxError3[TxError3["OBJECT_INVALID"] = 34] = "OBJECT_INVALID";
  TxError3[TxError3["INVALID_OBJECT_FIELD_PATH"] = 35] = "INVALID_OBJECT_FIELD_PATH";
  TxError3[TxError3["INVALID_OBJECT_FIELD_VALUE"] = 36] = "INVALID_OBJECT_FIELD_VALUE";
  return TxError3;
})(TxError || {});
...
var _ACEntry = class _ACEntry extends Message {
  constructor(data) {
    super();
    /**
  ...
  static fromBinary(bytes, options) {
    return new _ACEntry().fromBinary(bytes, options);
  }
  static fromJson(jsonValue, options) {
    return new _ACEntry().fromJson(jsonValue, options);
  }
  static fromJsonString(jsonString, options) {
    return new _ACEntry().fromJsonString(jsonString, options);
  }
  static equals(a, b) {
    return proto3.util.equals(_ACEntry, a, b);
  }
};
_ACEntry.runtime = proto3;
_ACEntry.typeName = "auth.ACEntry";
_ACEntry.fields = proto3.util.newFieldList(() => [
  { no: 1, name: "children", kind: "map", K: 9, V: { kind: "message", T: PathPolicy } }
]);
var ACEntry = _ACEntry;
var _Object$ = class _Object$ extends Message {
  constructor(data) {
    super();
    proto3.util.initPartial(data, this);
  }
  static fromBinary(bytes, options) {
    return new _Object$().fromBinary(bytes, options);
  }
  static fromJson(jsonValue, options) {
    return new _Object$().fromJson(jsonValue, options);
  }
  static fromJsonString(jsonString, options) {
    return new _Object$().fromJsonString(jsonString, options);
  }
  static equals(a, b) {
    return proto3.util.equals(_Object$, a, b);
  }
};
_Object$.runtime = proto3;
_Object$.typeName = "auth.Object";
_Object$.fields = proto3.util.newFieldList(() => [
  { no: 1, name: "key", kind: "message", T: ObjectKey },
  { no: 2, name: "value", kind: "message", T: Any }
]);
var Object$ = _Object$;
var _FullObject = class _FullObject extends Message {
  constructor(data) {
    super();
    /**
  ...
  static fromBinary(bytes, options) {
    return new _FullObject().fromBinary(bytes, options);
  }
  static fromJson(jsonValue, options) {
    return new _FullObject().fromJson(jsonValue, options);
  }
  static fromJsonString(jsonString, options) {
    return new _FullObject().fromJsonString(jsonString, options);
  }
  static equals(a, b) {
    return proto3.util.equals(_FullObject, a, b);
  }
};
_FullObject.runtime = proto3;
_FullObject.typeName = "auth.FullObject";
_FullObject.fields = proto3.util.newFieldList(() => [
  { no: 1, name: "key", kind: "message", T: ObjectKey },
  { no: 2, name: "value", kind: "message", T: Any },
...
var FullObject = _FullObject;
var _ObjectKey = class _ObjectKey extends Message {
  constructor(data) {
    super();
    /**
  ...
  static fromBinary(bytes, options) {
    return new _ObjectKey().fromBinary(bytes, options);
  }
  static fromJson(jsonValue, options) {
    return new _ObjectKey().fromJson(jsonValue, options);
  }
  static fromJsonString(jsonString, options) {
    return new _ObjectKey().fromJsonString(jsonString, options);
  }
  static equals(a, b) {
    return proto3.util.equals(_ObjectKey, a, b);
  }
};
_ObjectKey.runtime = proto3;
_ObjectKey.typeName = "auth.ObjectKey";
_ObjectKey.fields = proto3.util.newFieldList(() => [
  {
    no: 1,
    name: "collection_id",
    kind: "scalar",
  ...
  { no: 3, name: "object_id_parts", kind: "scalar", T: 9, repeated: true }
]);
...
_Collection.fields = proto3.util.newFieldList(() => [
  ...
  { no: 4, name: "object_types", kind: "scalar", T: 9, repeated: true },
...
var _Membership = class _Membership extends Message {
  constructor(data) {
    super();
    /**
  ...
  static fromBinary(bytes, options) {
    return new _Membership().fromBinary(bytes, options);
  }
  static fromJson(jsonValue, options) {
    return new _Membership().fromJson(jsonValue, options);
  }
  static fromJsonString(jsonString, options) {
    return new _Membership().fromJsonString(jsonString, options);
  }
  static equals(a, b) {
    return proto3.util.equals(_Membership, a, b);
  }
};
_Membership.runtime = proto3;
_Membership.typeName = "auth.Membership";
_Membership.fields = proto3.util.newFieldList(() => [
  {
    no: 1,
    name: "collection_id",
    kind: "scalar",
...
__export(generic_pb_exports, {
  ...
  ReferenceByObjectRequest: () => ReferenceByObjectRequest,
  ReferenceByObjectResponse: () => ReferenceByObjectResponse,
  ...
  ReferenceListByTypeRequest: () => ReferenceListByTypeRequest,
  ReferenceListByTypeResponse: () => ReferenceListByTypeResponse,
  ...
  SuggestionListByObjectRequest: () => SuggestionListByObjectRequest,
  SuggestionListByObjectResponse: () => SuggestionListByObjectResponse,
...
var TransactionType2 = proto3.makeEnum(
...
var ObjectKind2 = proto3.makeEnum(
  "auth.ObjectKind",
  [
...
var KeySchema2 = proto3.makeMessageType(
  "auth.KeySchema",
  () => [
    {
      no: 1,
    ...
    { no: 2, name: "object_kind", kind: "enum", T: proto3.getEnumType(ObjectKind2) },
    { no: 3, name: "keys", kind: "message", T: FieldMask }
  ]
);
var StateActivity2 = proto3.makeMessageType(
  "auth.StateActivity",
  () => [
    {
      no: 1,
...
var HistoryEntry2 = proto3.makeMessageType(
  "auth.HistoryEntry",
  () => [
    {
      no: 1,
...
var History2 = proto3.makeMessageType(
  "auth.History",
  () => [
    { no: 1, name: "entries", kind: "message", T: HistoryEntry2, repeated: true },
    { no: 2, name: "hidden_txs", kind: "message", T: HiddenTxList2 }
  ]
);
var Operation2 = proto3.makeMessageType(
  "auth.Operation",
  () => [
    { no: 1, name: "action", kind: "enum", T: proto3.getEnumType(Action2) },
    {
      no: 2,
      name: "collection_id",
      kind: "scalar",
...
var PathPolicy2 = proto3.makeMessageType(
  "auth.PathPolicy",
  () => [
    {
      no: 1,
    ...
    { no: 4, name: "sub_paths", kind: "map", K: 9, V: { kind: "message", T: PathPolicy2 } },
    { no: 5, name: "actions", kind: "enum", T: proto3.getEnumType(Action2), repeated: true }
  ]
);
var ACEntry2 = proto3.makeMessageType(
  "auth.ACEntry",
  () => [
    { no: 1, name: "children", kind: "map", K: 9, V: { kind: "message", T: PathPolicy2 } }
  ]
);
var Object$2 = proto3.makeMessageType(
  "auth.Object",
  () => [
    { no: 1, name: "key", kind: "message", T: ObjectKey2 },
    { no: 2, name: "value", kind: "message", T: Any }
  ],
  { localName: "Object$" }
);
var FullObject2 = proto3.makeMessageType(
  "auth.FullObject",
  () => [
    { no: 1, name: "key", kind: "message", T: ObjectKey2 },
    { no: 2, name: "value", kind: "message", T: Any },
    { no: 3, name: "history", kind: "message", T: History2 },
    { no: 4, name: "suggestions", kind: "message", T: Suggestion2, repeated: true },
    { no: 5, name: "references", kind: "message", T: Reference2, repeated: true }
  ]
);
var ObjectKey2 = proto3.makeMessageType(
  "auth.ObjectKey",
  () => [
    {
      no: 1,
...
var Reference2 = proto3.makeMessageType(
  "auth.Reference",
  () => [
    {
      no: 1,
    ...
    { no: 3, name: "key_1", kind: "message", T: ObjectKey2 },
    { no: 4, name: "key_2", kind: "message", T: ObjectKey2 }
  ]
);
var Collection2 = proto3.makeMessageType(
  "auth.Collection",
  () => [
    {
      no: 1,
    ...
    { no: 4, name: "object_types", kind: "scalar", T: 9, repeated: true },
    { no: 5, name: "default", kind: "message", T: ACEntry2 }
  ]
);
var User2 = proto3.makeMessageType(
  "auth.User",
  () => [
    {
      no: 1,
...
var Suggestion2 = proto3.makeMessageType(
  "auth.Suggestion",
  () => [
    { no: 1, name: "primary_key", kind: "message", T: ObjectKey2 },
    {
      no: 2,
      name: "suggestion_id",
      kind: "scalar",
...
var HiddenTx2 = proto3.makeMessageType(
  "auth.HiddenTx",
  () => [
    {
      no: 1,
...
var HiddenTxList2 = proto3.makeMessageType(
  "auth.HiddenTxList",
  () => [
    { no: 1, name: "primary_key", kind: "message", T: ObjectKey2 },
    { no: 4, name: "txs", kind: "message", T: HiddenTx2, repeated: true }
  ]
);
var Role2 = proto3.makeMessageType(
  "auth.Role",
  () => [
    {
      no: 1,
    ...
    { no: 4, name: "ac", kind: "message", T: ACEntry2 },
    {
      no: 5,
      name: "description",
      kind: "scalar",
...
var Attribute2 = proto3.makeMessageType(
  "auth.Attribute",
  () => [
    {
      no: 1,
    ...
    { no: 5, name: "ac", kind: "message", T: ACEntry2 }
  ]
);
var Membership2 = proto3.makeMessageType(
  "auth.Membership",
  () => [
    {
      no: 1,
...
// gen/chaincode/auth/common/generic_pb.ts
var _GetAllTypesResponse = class _GetAllTypesResponse extends Message {
  constructor(data) {
    super();
    /**
  ...
  static fromBinary(bytes, options) {
    return new _GetAllTypesResponse().fromBinary(bytes, options);
  }
  static fromJson(jsonValue, options) {
    return new _GetAllTypesResponse().fromJson(jsonValue, options);
  }
  static fromJsonString(jsonString, options) {
    return new _GetAllTypesResponse().fromJsonString(jsonString, options);
  }
  static equals(a, b) {
    return proto3.util.equals(_GetAllTypesResponse, a, b);
  }
};
_GetAllTypesResponse.runtime = proto3;
_GetAllTypesResponse.typeName = "auth.common.GetAllTypesResponse";
_GetAllTypesResponse.fields = proto3.util.newFieldList(() => [
  { no: 1, name: "types", kind: "scalar", T: 9, repeated: true }
]);
var GetAllTypesResponse = _GetAllTypesResponse;
...
_GetCurrentUserResponse.fields = proto3.util.newFieldList(() => [
  { no: 1, name: "user", kind: "message", T: User2 }
]);
...
_AuthorizeOperationRequest.fields = proto3.util.newFieldList(() => [
  { no: 2, name: "operation", kind: "message", T: Operation2 }
]);
...
_GetRequest.fields = proto3.util.newFieldList(() => [
  { no: 3, name: "object", kind: "message", T: Object$2 }
]);
...
_GetResponse.fields = proto3.util.newFieldList(() => [
  { no: 1, name: "object", kind: "message", T: Object$2 }
]);
...
_ListResponse.fields = proto3.util.newFieldList(() => [
  ...
  { no: 2, name: "objects", kind: "message", T: Object$2, repeated: true }
]);
...
_CreateRequest.fields = proto3.util.newFieldList(() => [
  { no: 2, name: "object", kind: "message", T: Object$2 }
]);
...
_HistoryResponse.fields = proto3.util.newFieldList(() => [
  { no: 2, name: "history", kind: "message", T: History2 }
]);
...
_HiddenTxResponse.fields = proto3.util.newFieldList(() => [
  ...
  { no: 2, name: "hidden_txs", kind: "message", T: HiddenTx2, repeated: true }
]);
...
_HideTxRequest.fields = proto3.util.newFieldList(() => [
  { no: 1, name: "object", kind: "message", T: Object$2 },
  { no: 2, name: "hidden_tx", kind: "message", T: HiddenTx2 }
]);
...
_ReferenceRequest.fields = proto3.util.newFieldList(() => [
  { no: 1, name: "reference", kind: "message", T: Reference2 }
]);
...
var _ReferenceListByTypeRequest = class _ReferenceListByTypeRequest extends Message {
  constructor(data) {
    super();
    /**
     * @generated from field: string bookmark = 1;
  ...
  static fromBinary(bytes, options) {
    return new _ReferenceListByTypeRequest().fromBinary(bytes, options);
  }
  static fromJson(jsonValue, options) {
    return new _ReferenceListByTypeRequest().fromJson(jsonValue, options);
  }
  static fromJsonString(jsonString, options) {
    return new _ReferenceListByTypeRequest().fromJsonString(jsonString, options);
  }
  static equals(a, b) {
    return proto3.util.equals(_ReferenceListByTypeRequest, a, b);
  }
};
_ReferenceListByTypeRequest.runtime = proto3;
_ReferenceListByTypeRequest.typeName = "auth.common.ReferenceListByTypeRequest";
_ReferenceListByTypeRequest.fields = proto3.util.newFieldList(() => [
  {
    no: 1,
    name: "bookmark",
    kind: "scalar",
...
var ReferenceListByTypeRequest = _ReferenceListByTypeRequest;
var _ReferenceListByTypeResponse = class _ReferenceListByTypeResponse extends Message {
  constructor(data) {
    super();
    /**
     * @generated from field: string bookmark = 1;
  ...
  static fromBinary(bytes, options) {
    return new _ReferenceListByTypeResponse().fromBinary(bytes, options);
  }
  static fromJson(jsonValue, options) {
    return new _ReferenceListByTypeResponse().fromJson(jsonValue, options);
  }
  static fromJsonString(jsonString, options) {
    return new _ReferenceListByTypeResponse().fromJsonString(jsonString, options);
  }
  static equals(a, b) {
    return proto3.util.equals(_ReferenceListByTypeResponse, a, b);
  }
};
_ReferenceListByTypeResponse.runtime = proto3;
_ReferenceListByTypeResponse.typeName = "auth.common.ReferenceListByTypeResponse";
_ReferenceListByTypeResponse.fields = proto3.util.newFieldList(() => [
  {
    no: 1,
    name: "bookmark",
    kind: "scalar",
  ...
  { no: 2, name: "references", kind: "message", T: Reference2, repeated: true }
]);
var ReferenceListByTypeResponse = _ReferenceListByTypeResponse;
...
var _ReferenceByObjectRequest = class _ReferenceByObjectRequest extends Message {
  constructor(data) {
    super();
    /**
     * @generated from field: string bookmark = 1;
  ...
  static fromBinary(bytes, options) {
    return new _ReferenceByObjectRequest().fromBinary(bytes, options);
  }
  static fromJson(jsonValue, options) {
    return new _ReferenceByObjectRequest().fromJson(jsonValue, options);
  }
  static fromJsonString(jsonString, options) {
    return new _ReferenceByObjectRequest().fromJsonString(jsonString, options);
  }
  static equals(a, b) {
    return proto3.util.equals(_ReferenceByObjectRequest, a, b);
  }
};
_ReferenceByObjectRequest.runtime = proto3;
_ReferenceByObjectRequest.typeName = "auth.common.ReferenceByObjectRequest";
_ReferenceByObjectRequest.fields = proto3.util.newFieldList(() => [
  {
    no: 1,
    name: "bookmark",
    kind: "scalar",
  ...
  { no: 3, name: "object_key", kind: "message", T: ObjectKey2 },
  {
    no: 4,
    name: "reference_type",
    kind: "scalar",
...
var ReferenceByObjectRequest = _ReferenceByObjectRequest;
var _ReferenceByObjectResponse = class _ReferenceByObjectResponse extends Message {
  constructor(data) {
    super();
    /**
     * @generated from field: string bookmark = 1;
  ...
  static fromBinary(bytes, options) {
    return new _ReferenceByObjectResponse().fromBinary(bytes, options);
  }
  static fromJson(jsonValue, options) {
    return new _ReferenceByObjectResponse().fromJson(jsonValue, options);
  }
  static fromJsonString(jsonString, options) {
    return new _ReferenceByObjectResponse().fromJsonString(jsonString, options);
  }
  static equals(a, b) {
    return proto3.util.equals(_ReferenceByObjectResponse, a, b);
  }
};
_ReferenceByObjectResponse.runtime = proto3;
_ReferenceByObjectResponse.typeName = "auth.common.ReferenceByObjectResponse";
_ReferenceByObjectResponse.fields = proto3.util.newFieldList(() => [
  {
    no: 1,
    name: "bookmark",
    kind: "scalar",
...
var ReferenceByObjectResponse = _ReferenceByObjectResponse;
...
_SuggestionRequest.fields = proto3.util.newFieldList(() => [
  { no: 1, name: "object_key", kind: "message", T: ObjectKey2 },
  {
    no: 2,
    name: "suggestion_id",
    kind: "scalar",
...
_SuggestionResponse.fields = proto3.util.newFieldList(() => [
  { no: 1, name: "suggestion", kind: "message", T: Suggestion2 }
]);
...
_SuggestionListResponse.fields = proto3.util.newFieldList(() => [
  ...
  { no: 2, name: "suggestions", kind: "message", T: Suggestion2, repeated: true }
]);
...
var _SuggestionListByObjectRequest = class _SuggestionListByObjectRequest extends Message {
  constructor(data) {
    super();
    proto3.util.initPartial(data, this);
  }
  static fromBinary(bytes, options) {
    return new _SuggestionListByObjectRequest().fromBinary(bytes, options);
  }
  static fromJson(jsonValue, options) {
    return new _SuggestionListByObjectRequest().fromJson(jsonValue, options);
  }
  static fromJsonString(jsonString, options) {
    return new _SuggestionListByObjectRequest().fromJsonString(jsonString, options);
  }
  static equals(a, b) {
    return proto3.util.equals(_SuggestionListByObjectRequest, a, b);
  }
};
_SuggestionListByObjectRequest.runtime = proto3;
_SuggestionListByObjectRequest.typeName = "auth.common.SuggestionListByObjectRequest";
_SuggestionListByObjectRequest.fields = proto3.util.newFieldList(() => [
  { no: 1, name: "object_key", kind: "message", T: ObjectKey2 }
]);
var SuggestionListByObjectRequest = _SuggestionListByObjectRequest;
var _SuggestionListByObjectResponse = class _SuggestionListByObjectResponse extends Message {
  constructor(data) {
    super();
    /**
  ...
  static fromBinary(bytes, options) {
    return new _SuggestionListByObjectResponse().fromBinary(bytes, options);
  }
  static fromJson(jsonValue, options) {
    return new _SuggestionListByObjectResponse().fromJson(jsonValue, options);
  }
  static fromJsonString(jsonString, options) {
    return new _SuggestionListByObjectResponse().fromJsonString(jsonString, options);
  }
  static equals(a, b) {
    return proto3.util.equals(_SuggestionListByObjectResponse, a, b);
  }
};
_SuggestionListByObjectResponse.runtime = proto3;
_SuggestionListByObjectResponse.typeName = "auth.common.SuggestionListByObjectResponse";
_SuggestionListByObjectResponse.fields = proto3.util.newFieldList(() => [
  { no: 1, name: "suggestions", kind: "message", T: Suggestion2, repeated: true }
]);
var SuggestionListByObjectResponse = _SuggestionListByObjectResponse;
...
_SuggestionByPartialKeyRequest.fields = proto3.util.newFieldList(() => [
  ...
  { no: 4, name: "object_key", kind: "message", T: ObjectKey2 },
  {
    no: 5,
    name: "suggestion_id",
    kind: "scalar",
...
_SuggestionDeleteResponse.fields = proto3.util.newFieldList(() => [
  { no: 4, name: "suggestion", kind: "message", T: Suggestion2 }
]);
...
_Person.fields = proto3.util.newFieldList(() => [
  ...
  { no: 3, name: "friends", kind: "scalar", T: 9, repeated: true },
...
_Author.fields = proto3.util.newFieldList(() => [
  ...
  { no: 4, name: "degrees", kind: "map", K: 9, V: { kind: "message", T: Degree } }
]);
var Author = _Author;
...
__export(factory_exports, {
  ...
  createAuthorObject: () => createAuthorObject,
  registry: () => registry
});
