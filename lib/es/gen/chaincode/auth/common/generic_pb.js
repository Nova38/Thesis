...
import { Collection, HiddenTx, HiddenTxList, History, Item, ItemKey, Operation, Reference, ReferenceKey, Suggestion, User } from "../../../auth/v1/auth_pb.js";
 ...
 */
export const CreateCollectionRequest = proto3.makeMessageType(
  "auth.common.CreateCollectionRequest",
  () => [
 ...
 */
export const CreateCollectionResponse = proto3.makeMessageType(
  "auth.common.CreateCollectionResponse",
  () => [
    { no: 1, name: "collection", kind: "message", T: Collection },
  ],
);
