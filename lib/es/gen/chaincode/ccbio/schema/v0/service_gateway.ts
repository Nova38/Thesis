...
export class SpecimenServiceClient {
     ...
     */
    async specimenGet(request: SpecimenGetRequest, evaluate: bool ): Promise< SpecimenGetResponse> {
        if (evaluate) {
     ...
     */
    async specimenGetList(request: SpecimenGetListRequest, evaluate: bool ): Promise< SpecimenGetListResponse> {
        if (evaluate) {
            const promise = this.contract.evaluate(
                "SpecimenGetList",
                $request.toJsonString(this.jsonWriteOptions)
     ...
     */
    async specimenGetByCollection(request: SpecimenGetByCollectionRequest, evaluate: bool ): Promise< SpecimenGetByCollectionResponse> {
        if (evaluate) {
            const promise = this.contract.evaluate(
     ...
     */
    async specimenGetHistory(request: SpecimenGetHistoryRequest, evaluate: bool ): Promise< SpecimenGetHistoryResponse> {
        if (evaluate) {
            const promise = this.contract.evaluate(
                "SpecimenGetHistory",
                $request.toJsonString(this.jsonWriteOptions)
     ...
     */
    async specimenCreate(request: SpecimenCreateRequest, evaluate: bool ): Promise< SpecimenCreateResponse> {
        if (evaluate) {
            const promise = this.contract.evaluate(
                "SpecimenCreate",
                $request.toJsonString(this.jsonWriteOptions)
     ...
     */
    async specimenUpdate(request: SpecimenUpdateRequest, evaluate: bool ): Promise< SpecimenUpdateResponse> {
        if (evaluate) {
            const promise = this.contract.evaluate(
                "SpecimenUpdate",
                $request.toJsonString(this.jsonWriteOptions)
     ...
     */
    async specimenDelete(request: SpecimenDeleteRequest, evaluate: bool ): Promise< SpecimenDeleteResponse> {
        if (evaluate) {
            const promise = this.contract.evaluate(
                "SpecimenDelete",
                $request.toJsonString(this.jsonWriteOptions)
     ...
     */
    async specimenHideTx(request: SpecimenHideTxRequest, evaluate: bool ): Promise< SpecimenHideTxResponse> {
        if (evaluate) {
            const promise = this.contract.evaluate(
                "SpecimenHideTx",
                $request.toJsonString(this.jsonWriteOptions)
     ...
     */
    async specimenUnHideTx(request: SpecimenUnHideTxRequest, evaluate: bool ): Promise< SpecimenUnHideTxResponse> {
        if (evaluate) {
            const promise = this.contract.evaluate(
                "SpecimenUnHideTx",
                $request.toJsonString(this.jsonWriteOptions)
