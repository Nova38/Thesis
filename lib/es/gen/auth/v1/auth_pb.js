 ...
 */
export const Polices = proto3.makeMessageType(
  "auth.Polices",
  () => [
...
export const Collection = proto3.makeMessageType(
  ...
  () => [
    ...
    { no: 6, name: "default", kind: "message", T: Polices },
  ],
);
 ...
 */
export const UserMembership = proto3.makeMessageType(
  "auth.UserMembership",
  () => [
    { no: 1, name: "collection_id", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 2, name: "msp_id", kind: "scalar", T: 9 /* ScalarType.STRING */ },
 ...
 */
export const UserCollectionRoles = proto3.makeMessageType(
