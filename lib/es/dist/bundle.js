...
var GenericServiceClient = class {
   ...
   */
  async getCurrentUser(request, evaluate) {
    if (evaluate) {
      const promise2 = this.contract.evaluate(
        "GetCurrentUser",
        $request.toJsonString(this.jsonWriteOptions)
      );
    } else {
      const promise2 = this.contract.submit(
        "GetCurrentUser",
        $request.toJsonString(this.jsonWriteOptions)
      );
    }
   ...
   */
  async bootstrap(request, evaluate) {
    if (evaluate) {
      const promise2 = this.contract.evaluate(
        "Bootstrap",
        $request.toJsonString(this.jsonWriteOptions)
   ...
   */
  async authorizeOperation(request, evaluate) {
    if (evaluate) {
      const promise2 = this.contract.evaluate(
        "AuthorizeOperation",
        $request.toJsonString(this.jsonWriteOptions)
   ...
   */
  async createUser(request, evaluate) {
    if (evaluate) {
      const promise2 = this.contract.evaluate(
        "CreateUser",
        $request.toJsonString(this.jsonWriteOptions)
   ...
   */
  async createCollection(request, evaluate) {
    if (evaluate) {
      const promise2 = this.contract.evaluate(
        "CreateCollection",
        $request.toJsonString(this.jsonWriteOptions)
   ...
   */
  async listByCollection(request, evaluate) {
    if (evaluate) {
      const promise2 = this.contract.evaluate(
        "ListByCollection",
        $request.toJsonString(this.jsonWriteOptions)
   ...
   */
  async listByAttrs(request, evaluate) {
    if (evaluate) {
      const promise2 = this.contract.evaluate(
        "ListByAttrs",
        $request.toJsonString(this.jsonWriteOptions)
   ...
   */
  async history(request, evaluate) {
    if (evaluate) {
      const promise2 = this.contract.evaluate(
        "History",
        $request.toJsonString(this.jsonWriteOptions)
   ...
   */
  async hiddenTx(request, evaluate) {
    if (evaluate) {
      const promise2 = this.contract.evaluate(
        "HiddenTx",
        $request.toJsonString(this.jsonWriteOptions)
   ...
   */
  async unHideTx(request, evaluate) {
    if (evaluate) {
      const promise2 = this.contract.evaluate(
        "UnHideTx",
        $request.toJsonString(this.jsonWriteOptions)
   ...
   */
  async reference(request, evaluate) {
    if (evaluate) {
      const promise2 = this.contract.evaluate(
        "Reference",
        $request.toJsonString(this.jsonWriteOptions)
   ...
   */
  async referenceByItem(request, evaluate) {
    if (evaluate) {
      const promise2 = this.contract.evaluate(
        "ReferenceByItem",
        $request.toJsonString(this.jsonWriteOptions)
   ...
   */
  async referenceByPartialKey(request, evaluate) {
    if (evaluate) {
      const promise2 = this.contract.evaluate(
   ...
   */
  async referenceCreate(request, evaluate) {
    if (evaluate) {
      const promise2 = this.contract.evaluate(
        "ReferenceCreate",
        $request.toJsonString(this.jsonWriteOptions)
   ...
   */
  async referenceDelete(request, evaluate) {
    if (evaluate) {
      const promise2 = this.contract.evaluate(
        "ReferenceDelete",
        $request.toJsonString(this.jsonWriteOptions)
   ...
   */
  async suggestion(request, evaluate) {
    if (evaluate) {
      const promise2 = this.contract.evaluate(
        "Suggestion",
        $request.toJsonString(this.jsonWriteOptions)
   ...
   */
  async suggestionListByCollection(request, evaluate) {
    if (evaluate) {
      const promise2 = this.contract.evaluate(
   ...
   */
  async suggestionByPartialKey(request, evaluate) {
    if (evaluate) {
      const promise2 = this.contract.evaluate(
   ...
   */
  async suggestionCreate(request, evaluate) {
    if (evaluate) {
      const promise2 = this.contract.evaluate(
        "SuggestionCreate",
        $request.toJsonString(this.jsonWriteOptions)
   ...
   */
  async suggestionDelete(request, evaluate) {
    if (evaluate) {
      const promise2 = this.contract.evaluate(
        "SuggestionDelete",
        $request.toJsonString(this.jsonWriteOptions)
   ...
   */
  async suggestionApprove(request, evaluate) {
    if (evaluate) {
      const promise2 = this.contract.evaluate(
        "SuggestionApprove",
        $request.toJsonString(this.jsonWriteOptions)
...
var SpecimenServiceClient = class {
   ...
   */
  async specimenGet(request, evaluate) {
    if (evaluate) {
      const promise2 = this.contract.evaluate(
        "SpecimenGet",
        $request.toJsonString(this.jsonWriteOptions)
   ...
   */
  async specimenGetList(request, evaluate) {
    if (evaluate) {
      const promise2 = this.contract.evaluate(
        "SpecimenGetList",
        $request.toJsonString(this.jsonWriteOptions)
   ...
   */
  async specimenGetByCollection(request, evaluate) {
    if (evaluate) {
      const promise2 = this.contract.evaluate(
   ...
   */
  async specimenGetHistory(request, evaluate) {
    if (evaluate) {
      const promise2 = this.contract.evaluate(
        "SpecimenGetHistory",
        $request.toJsonString(this.jsonWriteOptions)
   ...
   */
  async specimenCreate(request, evaluate) {
    if (evaluate) {
      const promise2 = this.contract.evaluate(
        "SpecimenCreate",
        $request.toJsonString(this.jsonWriteOptions)
   ...
   */
  async specimenUpdate(request, evaluate) {
    if (evaluate) {
      const promise2 = this.contract.evaluate(
        "SpecimenUpdate",
        $request.toJsonString(this.jsonWriteOptions)
   ...
   */
  async specimenDelete(request, evaluate) {
    if (evaluate) {
      const promise2 = this.contract.evaluate(
        "SpecimenDelete",
        $request.toJsonString(this.jsonWriteOptions)
   ...
   */
  async specimenHideTx(request, evaluate) {
    if (evaluate) {
      const promise2 = this.contract.evaluate(
        "SpecimenHideTx",
        $request.toJsonString(this.jsonWriteOptions)
   ...
   */
  async specimenUnHideTx(request, evaluate) {
    if (evaluate) {
      const promise2 = this.contract.evaluate(
        "SpecimenUnHideTx",
        $request.toJsonString(this.jsonWriteOptions)
