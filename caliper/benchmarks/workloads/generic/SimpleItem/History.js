...
// History hlf.pb.common.generic.HistoryRequest
...
async submitTransaction() {
    ...
    const item = new hlf.pb.common.generic.HistoryRequest({})


    const myArgs = {
        contractId: this.contractId,

        contractFunction: 'History',
        contractArguments: [
