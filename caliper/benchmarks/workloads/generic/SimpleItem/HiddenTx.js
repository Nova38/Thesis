...
// HiddenTx hlf.pb.common.generic.HiddenTxRequest
...
async submitTransaction() {
    ...
    const item = new hlf.pb.common.generic.HiddenTxRequest({})


    const myArgs = {
        contractId: this.contractId,

        contractFunction: 'HiddenTx',
        contractArguments: [
