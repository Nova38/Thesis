 ...
 *
 * @type {genericSuggestionByPartialKeyWorkload}
 * @property {string} contractId The name of the contract.
 * @property {string} contractVersion The version of the contract.
 */
class genericSuggestionByPartialKeyWorkload extends WorkloadModuleBase {
...
async submitTransaction() {
    ...
    const item = new hlf.pb.common.generic.SuggestionByPartialKeyRequest({})


    const myArgs = {
        contractId: this.contractId,

        contractFunction: 'SuggestionByPartialKey',
        contractArguments: [
