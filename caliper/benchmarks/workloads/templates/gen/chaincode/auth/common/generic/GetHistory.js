...
// GetHistory hlf.pb.common.generic.GetHistoryRequest
...
async submitTransaction() {
    ...
    const item = new hlf.pb.common.generic.GetHistoryRequest({arg.item})
