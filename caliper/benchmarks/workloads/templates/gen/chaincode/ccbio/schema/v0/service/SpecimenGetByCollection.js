 ...
 *
 * @type {serviceSpecimenGetByCollectionWorkload}
 * @property {string} contractId The name of the contract.
 * @property {string} contractVersion The version of the contract.
 */
class serviceSpecimenGetByCollectionWorkload extends WorkloadModuleBase {
...
// workload path hlf.pb.v0.service
// SpecimenGetByCollection hlf.pb.v0.service.SpecimenGetByCollectionRequest
...
async submitTransaction() {
    ...
    const item = new hlf.pb.v0.service.SpecimenGetByCollectionRequest({arg.item})

    /** @type {PeerGateway.FabricRequestSettings}*/
    const myArgs = {
        contractId: this.contractId,

        contractFunction: 'SpecimenGetByCollection',
        contractArguments: [
