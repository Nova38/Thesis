...
// SpecimenDelete hlf.pb.v0.service.SpecimenDeleteRequest
...
async submitTransaction() {
    ...
    const item = new hlf.pb.v0.service.SpecimenDeleteRequest({arg.item})

    /** @type {PeerGateway.FabricRequestSettings}*/
    const myArgs = {
        contractId: this.contractId,

        contractFunction: 'SpecimenDelete',
        contractArguments: [
