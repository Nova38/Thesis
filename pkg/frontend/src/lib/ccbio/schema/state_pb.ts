...
// @generated from file schema/state.proto (package schema, syntax proto3)
/* eslint-disable */
// @ts-nocheck
...
/**
 * @generated from enum schema.Role
 */
export enum Role {
  /**
...
proto3.util.setEnumType(Role, "schema.Role", [
...
/**
 * @generated from message schema.LastModified
 */
export class LastModified extends Message<LastModified> {
  ...
  static readonly typeName = "schema.LastModified";
...
/**
 * @generated from message schema.Action
 */
export class Action extends Message<Action> {
  /**
   * @generated from field: schema.Action.Level level = 1;
   */
  level = Action_Level.UNSPECIFIED;

  /**
   * @generated from field: repeated schema.Action.Domain domains = 2;
   */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "schema.Action";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from enum schema.Action.Level
 */
...
proto3.util.setEnumType(Action_Level, "schema.Action.Level", [
...
/**
 * @generated from enum schema.Action.Domain
 */
...
proto3.util.setEnumType(Action_Domain, "schema.Action.Domain", [
 ...
 * --------------------------------------------------
 *
 * @generated from message schema.Collection
 */
export class Collection extends Message<Collection> {
  ...
  /**
   * @generated from field: schema.Collection.AccessControl access_control = 2;
   */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "schema.Collection";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message schema.Collection.Id
 */
export class Collection_Id extends Message<Collection_Id> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "schema.Collection.Id";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message schema.Collection.List
 */
export class Collection_List extends Message<Collection_List> {
  /**
   * @generated from field: repeated schema.Collection items = 1;
   */
  items: Collection[] = [];
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "schema.Collection.List";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message schema.Collection.AccessControl
 */
export class Collection_AccessControl extends Message<Collection_AccessControl> {
   ...
   *
   *
   * @generated from field: schema.Collection.AccessControl.AccessControlActions roles = 1;
   */
   ...
   *
   * @generated from field: schema.Collection.AccessControl.AccessControlActions users = 2;
   */
   ...
   *
   * @generated from field: schema.Collection.AccessControl.SpecimenActions specimen = 3;
   */
   ...
   *
   * @generated from field: schema.Collection.AccessControl.SectionActions primary = 4;
   */
   ...
   *
   * @generated from field: schema.Collection.AccessControl.SectionActions secondary = 5;
   */
   ...
   *
   * @generated from field: schema.Collection.AccessControl.SectionActions taxon = 6;
   */
   ...
   *
   * @generated from field: schema.Collection.AccessControl.SectionActions georeference = 7;
   */
   ...
   *
   * @generated from field: schema.Collection.AccessControl.SectionActions images = 8;
   */
   ...
   *
   * @generated from field: schema.Collection.AccessControl.SectionActions loans = 9;
   */
   ...
   *
   * @generated from field: schema.Collection.AccessControl.SectionActions grants = 10;
   */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "schema.Collection.AccessControl";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message schema.Collection.AccessControl.AccessControlActions
 */
export class Collection_AccessControl_AccessControlActions extends Message<Collection_AccessControl_AccessControlActions> {
  /**
   * @generated from field: repeated schema.Role view = 1;
   */
  view: Role[] = [];

  /**
   * @generated from field: repeated schema.Role edit = 2;
   */
  edit: Role[] = [];
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "schema.Collection.AccessControl.AccessControlActions";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message schema.Collection.AccessControl.SpecimenActions
 */
export class Collection_AccessControl_SpecimenActions extends Message<Collection_AccessControl_SpecimenActions> {
  ...
  /**
   * @generated from field: repeated schema.Role create = 2;
   */
  create: Role[] = [];

  /**
   * @generated from field: repeated schema.Role delete = 3;
   */
  delete: Role[] = [];
   ...
   *
   * @generated from field: repeated schema.Role hide_tx = 4;
   */
  hideTx: Role[] = [];
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "schema.Collection.AccessControl.SpecimenActions";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "view", kind: "enum", T: proto3.getEnumType(Role), repeated: true },
...
/**
 * @generated from message schema.Collection.AccessControl.SectionActions
 */
export class Collection_AccessControl_SectionActions extends Message<Collection_AccessControl_SectionActions> {
  ...
  /**
   * @generated from field: repeated schema.Role suggest_edit = 3;
   */
  suggestEdit: Role[] = [];

  /**
   * @generated from field: repeated schema.Role suggest_approve = 4;
   */
  suggestApprove: Role[] = [];

  /**
   * @generated from field: repeated schema.Role suggest_reject = 5;
   */
  suggestReject: Role[] = [];
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "schema.Collection.AccessControl.SectionActions";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "view", kind: "enum", T: proto3.getEnumType(Role), repeated: true },
    { no: 2, name: "edit", kind: "enum", T: proto3.getEnumType(Role), repeated: true },
...
/**
 * @generated from message schema.CollectionList
 */
export class CollectionList extends Message<CollectionList> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "schema.CollectionList";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "items", kind: "message", T: Collection, repeated: true },
  ]);
...
/**
 * @generated from message schema.User
 */
export class User extends Message<User> {
   ...
   *
   * @generated from field: map<string, schema.Role> memberships = 5;
   */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "schema.User";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 *
 * @generated from message schema.User.Id
 */
export class User_Id extends Message<User_Id> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "schema.User.Id";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message schema.User.List
 */
export class User_List extends Message<User_List> {
  /**
   * @generated from field: repeated schema.User items = 1;
   */
  items: User[] = [];
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "schema.User.List";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message schema.Specimen
 */
export class Specimen extends Message<Specimen> {
  ...
  /**
   * @generated from field: schema.Specimen.Taxon taxon = 5;
   */
  taxon?: Specimen_Taxon;

  /**
   * @generated from field: schema.Specimen.Georeference georeference = 6;
   */
   ...
   *
   * @generated from field: map<string, schema.Specimen.HiddenTx> hidden_txs = 10;
   */
  hiddenTxs: { [key: string]: Specimen_HiddenTx } = {};

  /**
   * @generated from field: schema.LastModified last_modified = 20;
   */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "schema.Specimen";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message schema.Specimen.Id
 */
export class Specimen_Id extends Message<Specimen_Id> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "schema.Specimen.Id";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "collection_id", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 2, name: "id", kind: "scalar", T: 9 /* ScalarType.STRING */ },
  ]);
...
/**
 * @generated from message schema.Specimen.List
 */
export class Specimen_List extends Message<Specimen_List> {
  /**
   * @generated from field: repeated schema.Specimen items = 1;
   */
  items: Specimen[] = [];
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "schema.Specimen.List";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message schema.Specimen.History
 */
export class Specimen_History extends Message<Specimen_History> {
  ...
  /**
   * @generated from field: repeated schema.Specimen.History.Entry entries = 2;
   */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "schema.Specimen.History";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "id", kind: "message", T: Specimen_Id },
...
/**
 * @generated from message schema.Specimen.History.Entry
 */
export class Specimen_History_Entry extends Message<Specimen_History_Entry> {
  ...
  /**
   * @generated from field: schema.Specimen state = 5;
   */
  state?: Specimen;
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "schema.Specimen.History.Entry";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message schema.Specimen.Primary
 */
export class Specimen_Primary extends Message<Specimen_Primary> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "schema.Specimen.Primary";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message schema.Specimen.Secondary
 */
export class Specimen_Secondary extends Message<Specimen_Secondary> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "schema.Specimen.Secondary";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message schema.Specimen.Taxon
 */
export class Specimen_Taxon extends Message<Specimen_Taxon> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "schema.Specimen.Taxon";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message schema.Specimen.Georeference
 */
export class Specimen_Georeference extends Message<Specimen_Georeference> {
  ...
  /**
   * @generated from field: schema.LastModified last_modified = 10;
   */
  lastModified?: LastModified;
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "schema.Specimen.Georeference";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 * Mapped Types
 *
 * @generated from message schema.Specimen.Image
 */
export class Specimen_Image extends Message<Specimen_Image> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "schema.Specimen.Image";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message schema.Specimen.HiddenTx
 */
export class Specimen_HiddenTx extends Message<Specimen_HiddenTx> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "schema.Specimen.HiddenTx";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "tx_id", kind: "scalar", T: 9 /* ScalarType.STRING */ },
...
/**
 * @generated from message schema.SuggestedUpdate
 */
export class SuggestedUpdate extends Message<SuggestedUpdate> {
  ...
  /**
   * @generated from field: schema.User.Id suggested_by = 3;
   */
  suggestedBy?: User_Id;
  ...
  /**
   * @generated from field: schema.Specimen.Primary primary = 6;
   */
  primary?: Specimen_Primary;

  /**
   * @generated from field: schema.Specimen.Secondary secondary = 7;
   */
  secondary?: Specimen_Secondary;

  /**
   * @generated from field: schema.Specimen.Taxon taxon = 8;
   */
  taxon?: Specimen_Taxon;

  /**
   * @generated from field: schema.Specimen.Georeference georeference = 9;
   */
  georeference?: Specimen_Georeference;
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "schema.SuggestedUpdate";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message schema.SuggestedUpdate.Id
 */
export class SuggestedUpdate_Id extends Message<SuggestedUpdate_Id> {
  /**
   * @generated from field: schema.Specimen.Id specimen_id = 1;
   */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "schema.SuggestedUpdate.Id";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message schema.SuggestedStateList
 */
export class SuggestedStateList extends Message<SuggestedStateList> {
  /**
   * @generated from field: repeated schema.SuggestedUpdate items = 1;
   */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "schema.SuggestedStateList";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
