...
/**
  ...
  *
  * @checksum - 1c87adfd3eaa2ea6b919a3a1e7aa15f4abdf3ac7cf574790ee3d895a30d2a965
  * @variables - radius=rounded-lg,accentColor=sky,colorTemperature=gray,spacing=1.5,scale=sm,inputShadow=shadow-md,baseColorShade=600,borderShadeLightMode=400,borderShadeDarkMode=500,inputMaxWidth=max-w-[22em],tagRadius=rounded-full,swatchRadius=rounded
  * @theme - regenesis
  **/
