 ...
 *
 * @checksum - c5d9644f68d82cf47ac7beaa0eaef51fdec883cfd8607deae3d08562730002ff
 * @variables - radius=rounded-xl,accentColor=blue,colorTemperature=slate,spacing=2,scale=base,inputShadow=shadow-md,baseColorShade=600,borderShadeLightMode=400,borderShadeDarkMode=500,inputMaxWidth=max-w-[22em],tagRadius=rounded-full,swatchRadius=rounded
 * @theme - regenesis
 **/
...
const classes: Record<string, Record<string, boolean>> = {
  ...
  range__input: {
    ...
    'dark:[&::-webkit-slider-thumb]:group-data-[disabled]:!ring-slate-600':
      true,
  ...
  'multi-step__tab': {
    ...
    'dark:group-data-[tab-style="progress"]/wrapper:before:border-slate-600':
      true,
