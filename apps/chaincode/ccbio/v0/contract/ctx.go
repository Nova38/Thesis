...
var _ auth.TxCtxInterface = (*CCBioTxCtx)(nil)
...
func (ctx *CCBioTxCtx) FetchTransactionItems() (err error) {
	...
	if ctx.Specimen.Id != nil {
		ctx.Collection.Id = &auth_pb.Collection_Id{CollectionId: ctx.Specimen.Id.CollectionId}
...
func (ctx *CCBioTxCtx) HandleFnError(e *error, a any) {
...
// nolint:cyclop
func extractCollectionId(req interface{}) (id *auth_pb.Collection_Id, err error) {
	if req == nil {
		return nil, oops.Errorf("Interface is a nil pointer")
	}
	...
	case specimenHolder:
		...
		id = &auth_pb.Collection_Id{CollectionId: v.GetSpecimen().GetId().CollectionId}

	case specimenIdHolder:
		if v.GetId() == nil {
			return nil, oops.Errorf("Collection is not set")
		}
		id = &auth_pb.Collection_Id{CollectionId: v.GetId().CollectionId}
	...
	case suggestedUpdateHolder:
		...
		id = &auth_pb.Collection_Id{CollectionId: s.GetId().GetSpecimenId().CollectionId}
	...
	case suggestedUpdateIdHolder:
		...
		id = &auth_pb.Collection_Id{CollectionId: v.GetId().GetSpecimenId().CollectionId}
