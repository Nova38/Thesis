...
// Suggestion hlf.pb.common.generic.SuggestionRequest
...
async submitTransaction() {
    ...
    const item = new hlf.pb.common.generic.SuggestionRequest({})


    const myArgs = {
        contractId: this.contractId,

        contractFunction: 'Suggestion',
        contractArguments: [
