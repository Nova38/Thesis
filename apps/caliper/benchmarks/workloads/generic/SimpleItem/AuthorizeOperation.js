...
async submitTransaction() {
    ...
    const item = new hlf.pb.pb.AuthorizeOperationRequest({})


    const myArgs = {
        contractId: this.contractId,

        contractFunction: 'AuthorizeOperation',
        contractArguments: [
