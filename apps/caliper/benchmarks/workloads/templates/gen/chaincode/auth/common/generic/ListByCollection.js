...
async submitTransaction() {
    ...
    const item = new hlf.pb.pb.ListByCollectionRequest({arg.item})

    /** @type {PeerGateway.FabricRequestSettings}*/
    const myArgs = {
        contractId: this.contractId,

        contractFunction: 'ListByCollection',
        contractArguments: [
