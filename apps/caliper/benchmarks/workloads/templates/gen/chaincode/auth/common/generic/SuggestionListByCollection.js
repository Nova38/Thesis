 ...
 *
 * @type {genericSuggestionListByCollectionWorkload}
 * @property {string} contractId The name of the contract.
 * @property {string} contractVersion The version of the contract.
 */
class genericSuggestionListByCollectionWorkload extends WorkloadModuleBase {
...
// SuggestionListByCollection hlf.pb.common.generic.SuggestionListByCollectionRequest
...
async submitTransaction() {
    ...
    const item = new hlf.pb.common.generic.SuggestionListByCollectionRequest({arg.item})

    /** @type {PeerGateway.FabricRequestSettings}*/
    const myArgs = {
        contractId: this.contractId,

        contractFunction: 'SuggestionListByCollection',
        contractArguments: [
