...
// ReferenceDelete hlf.pb.common.reference.ReferenceDeleteRequest
...
async submitTransaction() {
    ...
    const item = new hlf.pb.common.reference.ReferenceDeleteRequest({arg.item})

    /** @type {PeerGateway.FabricRequestSettings}*/
    const myArgs = {
        contractId: this.contractId,

        contractFunction: 'ReferenceDelete',
        contractArguments: [
