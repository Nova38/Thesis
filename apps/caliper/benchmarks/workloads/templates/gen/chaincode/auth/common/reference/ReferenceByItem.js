...
// ReferenceByItem hlf.pb.common.reference.ReferenceByItemRequest
...
async submitTransaction() {
    ...
    const item = new hlf.pb.common.reference.ReferenceByItemRequest({arg.item})

    /** @type {PeerGateway.FabricRequestSettings}*/
    const myArgs = {
        contractId: this.contractId,

        contractFunction: 'ReferenceByItem',
        contractArguments: [
