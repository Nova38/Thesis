...
// Bootstrap hlf.pb.common.generic.BootstrapRequest
...
async submitTransaction() {
    ...
    const item = new hlf.pb.common.generic.BootstrapRequest({arg.item})
