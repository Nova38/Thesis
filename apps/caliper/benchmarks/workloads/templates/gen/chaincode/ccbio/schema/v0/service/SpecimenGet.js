...
// SpecimenGet hlf.pb.v0.service.SpecimenGetRequest
...
async submitTransaction() {
    ...
    const item = new hlf.pb.v0.service.SpecimenGetRequest({arg.item})

    /** @type {PeerGateway.FabricRequestSettings}*/
    const myArgs = {
        contractId: this.contractId,

        contractFunction: 'SpecimenGet',
        contractArguments: [
