...
// SpecimenGetList hlf.pb.v0.service.SpecimenGetListRequest
...
async submitTransaction() {
    ...
    const item = new hlf.pb.v0.service.SpecimenGetListRequest({arg.item})

    /** @type {PeerGateway.FabricRequestSettings}*/
    const myArgs = {
        contractId: this.contractId,

        contractFunction: 'SpecimenGetList',
        contractArguments: [
