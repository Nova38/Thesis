      ...
      this.items.push(
        saacs.PrimaryToItem(
          new pb.Book({
            ...
            isbn: `isbn-${i}`,
            author: this.workerIndex === 0 ? 'u-author' : '',
            description: this.workerIndex === 1 ? 'u-description' : '',
            publisher: this.workerIndex === 2 ? 'u-publisher' : '',
            year: this.workerIndex === 3 ? 1 : 0,
            language: '',
          }),
        ),
      )
