...
// ReferenceCreate hlf.pb.common.reference.ReferenceCreateRequest
...
async submitTransaction() {
    ...
    const item = new hlf.pb.common.reference.ReferenceCreateRequest({arg.item})

    /** @type {PeerGateway.FabricRequestSettings}*/
    const myArgs = {
        contractId: this.contractId,

        contractFunction: 'ReferenceCreate',
        contractArguments: [
