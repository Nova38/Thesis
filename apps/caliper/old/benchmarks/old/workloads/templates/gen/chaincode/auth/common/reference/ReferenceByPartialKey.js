 ...
 *
 * @type {referenceReferenceByPartialKeyWorkload}
 * @property {string} contractId The name of the contract.
 * @property {string} contractVersion The version of the contract.
 */
class referenceReferenceByPartialKeyWorkload extends WorkloadModuleBase {
...
// ReferenceByPartialKey hlf.pb.common.reference.ReferenceByPartialKeyRequest
...
async submitTransaction() {
    ...
    const item = new hlf.pb.common.reference.ReferenceByPartialKeyRequest({arg.item})

    /** @type {PeerGateway.FabricRequestSettings}*/
    const myArgs = {
        contractId: this.contractId,

        contractFunction: 'ReferenceByPartialKey',
        contractArguments: [
