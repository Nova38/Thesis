...
// SpecimenUnHideTx hlf.pb.v0.service.SpecimenUnHideTxRequest
...
async submitTransaction() {
    ...
    const item = new hlf.pb.v0.service.SpecimenUnHideTxRequest({arg.item})

    /** @type {PeerGateway.FabricRequestSettings}*/
    const myArgs = {
        contractId: this.contractId,

        contractFunction: 'SpecimenUnHideTx',
        contractArguments: [
