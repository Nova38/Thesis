...
// SpecimenGetHistory hlf.pb.v0.service.SpecimenGetHistoryRequest
...
async submitTransaction() {
    ...
    const item = new hlf.pb.v0.service.SpecimenGetHistoryRequest({arg.item})

    /** @type {PeerGateway.FabricRequestSettings}*/
    const myArgs = {
        contractId: this.contractId,

        contractFunction: 'SpecimenGetHistory',
        contractArguments: [
