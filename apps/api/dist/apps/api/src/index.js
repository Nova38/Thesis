...
var cryptoPath = envOrDefault('CRYPTO_PATH', path.resolve(__dirname, '..', '..', '..', 'network', 'test-network', 'organizations', 'peerOrganizations', 'org1.example.com'));
...
var schema = require("../../../lib/es/gen/chaincode/auth/common/generic_pb");
var auth_pb_1 = require("../../../lib/es/gen/auth/v1/auth_pb");
function main() {
...
function initLedger(contract) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            ...
            item = new schema.AuthorizeOperationRequest({});
            op = new auth_pb_1.Operation();
            op.toJson();
            console.log(bytes);
