...
export function NormalizeSpecimen(input: PlainMessage<pb.Specimen>): pb.Specimen {
  ...
  // if (typeof response.secondary.sex === 'string')
  //   response.secondary.sex = pb.Specimen_Secondary_SEX[response.secondary.sex as any]

  // if (typeof response.secondary.age === 'string')
  //   response.secondary.age = pb.Specimen_Secondary_AGE[response.secondary.age as any]
