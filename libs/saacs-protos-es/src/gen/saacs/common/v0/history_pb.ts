...
export class HiddenTx extends Message<HiddenTx> {
  ...
  static equals(
    a: HiddenTx | PlainMessage<HiddenTx> | undefined,
    b: HiddenTx | PlainMessage<HiddenTx> | undefined,
  ): boolean {
...
export class HiddenTxList extends Message<HiddenTxList> {
  ...
  static equals(
    a: HiddenTxList | PlainMessage<HiddenTxList> | undefined,
    b: HiddenTxList | PlainMessage<HiddenTxList> | undefined,
  ): boolean {
...
export class HistoryEntry extends Message<HistoryEntry> {
  ...
  static equals(
    a: HistoryEntry | PlainMessage<HistoryEntry> | undefined,
    b: HistoryEntry | PlainMessage<HistoryEntry> | undefined,
  ): boolean {
...
export class History extends Message<History> {
  ...
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    ...
    {
      no: 3,
      name: 'hidden_txs_by_msp_id',
      kind: 'map',
      K: 9 /* ScalarType.STRING */,
      V: { kind: 'message', T: HiddenTxList },
    },
  ])
...
export class HistoryOptions extends Message<HistoryOptions> {
  ...
  static equals(
    a: HistoryOptions | PlainMessage<HistoryOptions> | undefined,
    b: HistoryOptions | PlainMessage<HistoryOptions> | undefined,
  ): boolean {
...
export class HiddenOptions extends Message<HiddenOptions> {
  ...
  static equals(
    a: HiddenOptions | PlainMessage<HiddenOptions> | undefined,
    b: HiddenOptions | PlainMessage<HiddenOptions> | undefined,
  ): boolean {
