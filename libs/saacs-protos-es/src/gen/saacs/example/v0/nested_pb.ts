...
export class ItemWithNestedKey extends Message<ItemWithNestedKey> {
  ...
  static equals(
    a: ItemWithNestedKey | PlainMessage<ItemWithNestedKey> | undefined,
    b: ItemWithNestedKey | PlainMessage<ItemWithNestedKey> | undefined,
  ): boolean {
...
export class Nested extends Message<Nested> {
  ...
  static equals(
    a: Nested | PlainMessage<Nested> | undefined,
    b: Nested | PlainMessage<Nested> | undefined,
  ): boolean {
