...
export class UserGlobalRoles extends Message<UserGlobalRoles> {
  ...
  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): UserGlobalRoles {
    return new UserGlobalRoles().fromBinary(bytes, options);
  }

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): UserGlobalRoles {
    return new UserGlobalRoles().fromJson(jsonValue, options);
  }

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): UserGlobalRoles {
    return new UserGlobalRoles().fromJsonString(jsonString, options);
  }

  static equals(a: UserGlobalRoles | PlainMessage<UserGlobalRoles> | undefined, b: UserGlobalRoles | PlainMessage<UserGlobalRoles> | undefined): boolean {
