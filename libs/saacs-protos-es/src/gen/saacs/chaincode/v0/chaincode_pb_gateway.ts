...
export class ItemServiceClient  {
  ...
  async list(req: PartialMessage<ListRequest>): Promise<ListResponse> {
     ...
     */
  async listByAttrs(req: PartialMessage<ListByAttrsRequest>): Promise<ListByAttrsResponse> {
    const msg = req instanceof ListByAttrsRequest ? req : new ListByAttrsRequest(req);
    const results = utf8Decoder.decode(
      await this.contract.evaluateTransaction(
        "ListByAttrs",
        msg.toJsonString(this.jsonWriteOptions)
  ...
  async delete(req: PartialMessage<DeleteRequest>): Promise<DeleteResponse> {
     ...
     */
  async getHistory(req: PartialMessage<GetHistoryRequest>): Promise<GetHistoryResponse> {
    const msg = req instanceof GetHistoryRequest ? req : new GetHistoryRequest(req);
    const results = utf8Decoder.decode(
      await this.contract.evaluateTransaction(
        "GetHistory",
        msg.toJsonString(this.jsonWriteOptions)
     ...
     */
  async getHiddenTx(req: PartialMessage<GetHiddenTxRequest>): Promise<GetHiddenTxResponse> {
    const msg = req instanceof GetHiddenTxRequest ? req : new GetHiddenTxRequest(req);
    const results = utf8Decoder.decode(
      await this.contract.evaluateTransaction(
        "GetHiddenTx",
        msg.toJsonString(this.jsonWriteOptions)
  ...
  async hideTx(req: PartialMessage<HideTxRequest>): Promise<HideTxResponse> {
     ...
     */
  async unHideTx(req: PartialMessage<UnHideTxRequest>): Promise<UnHideTxResponse> {
     ...
     */
  async getSuggestion(req: PartialMessage<GetSuggestionRequest>): Promise<GetSuggestionResponse> {
    const msg = req instanceof GetSuggestionRequest ? req : new GetSuggestionRequest(req);
    const results = utf8Decoder.decode(
      await this.contract.evaluateTransaction(
        "GetSuggestion",
        msg.toJsonString(this.jsonWriteOptions)
     ...
     */
  async suggestionListByCollection(req: PartialMessage<SuggestionListByCollectionRequest>): Promise<SuggestionListByCollectionResponse> {
    const msg = req instanceof SuggestionListByCollectionRequest ? req : new SuggestionListByCollectionRequest(req);
    const results = utf8Decoder.decode(
      await this.contract.evaluateTransaction(
     ...
     */
  async suggestionListByItem(req: PartialMessage<SuggestionListByItemRequest>): Promise<SuggestionListByItemResponse> {
    const msg = req instanceof SuggestionListByItemRequest ? req : new SuggestionListByItemRequest(req);
    const results = utf8Decoder.decode(
      await this.contract.evaluateTransaction(
        "SuggestionListByItem",
        msg.toJsonString(this.jsonWriteOptions)
      ))
    return SuggestionListByItemResponse.fromJsonString(results, {typeRegistry: this.registry});
    }
     ...
     */
  async suggestionByPartialKey(req: PartialMessage<SuggestionByPartialKeyRequest>): Promise<SuggestionByPartialKeyResponse> {
    const msg = req instanceof SuggestionByPartialKeyRequest ? req : new SuggestionByPartialKeyRequest(req);
    const results = utf8Decoder.decode(
      await this.contract.evaluateTransaction(
     ...
     */
  async suggestionCreate(req: PartialMessage<SuggestionCreateRequest>): Promise<SuggestionCreateResponse> {
    const msg = req instanceof SuggestionCreateRequest ? req : new SuggestionCreateRequest(req);
    const results = utf8Decoder.decode(
      await this.contract.submitTransaction(
        "SuggestionCreate",
        msg.toJsonString(this.jsonWriteOptions)
     ...
     */
  async suggestionDelete(req: PartialMessage<SuggestionDeleteRequest>): Promise<SuggestionDeleteResponse> {
    const msg = req instanceof SuggestionDeleteRequest ? req : new SuggestionDeleteRequest(req);
    const results = utf8Decoder.decode(
      await this.contract.submitTransaction(
        "SuggestionDelete",
        msg.toJsonString(this.jsonWriteOptions)
     ...
     */
  async suggestionApprove(req: PartialMessage<SuggestionApproveRequest>): Promise<SuggestionApproveResponse> {
    const msg = req instanceof SuggestionApproveRequest ? req : new SuggestionApproveRequest(req);
    const results = utf8Decoder.decode(
      await this.contract.submitTransaction(
        "SuggestionApprove",
        msg.toJsonString(this.jsonWriteOptions)
