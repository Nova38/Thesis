...
// @generated from file ccbio/schema/v1/state.proto (package ccbio.schemav1, syntax proto3)
/* eslint-disable */
// @ts-nocheck
...
/**
 * @generated from enum ccbio.schemav1.Role
 */
export enum Role {
  /**
...
proto3.util.setEnumType(Role, "ccbio.schemav1.Role", [
...
/**
 * @generated from message ccbio.schemav1.LastModified
 */
export class LastModified extends Message<LastModified> {
  /**
   * @generated from field: ccbio.schemav1.User.Id user_id = 1;
   */
  userId?: User_Id;
  ...
  static readonly typeName = "ccbio.schemav1.LastModified";
...
/**
 * @generated from message ccbio.schemav1.Action
 */
export class Action extends Message<Action> {
  /**
   * @generated from field: ccbio.schemav1.Action.Level level = 1;
   */
  level = Action_Level.UNSPECIFIED;

  /**
   * @generated from field: repeated ccbio.schemav1.Action.Domain domains = 2;
   */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "ccbio.schemav1.Action";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from enum ccbio.schemav1.Action.Level
 */
...
proto3.util.setEnumType(Action_Level, "ccbio.schemav1.Action.Level", [
...
/**
 * @generated from enum ccbio.schemav1.Action.Domain
 */
...
proto3.util.setEnumType(Action_Domain, "ccbio.schemav1.Action.Domain", [
 ...
 * --------------------------------------------------
 *
 * @generated from message ccbio.schemav1.Collection
 */
export class Collection extends Message<Collection> {
  /**
   * buf:lint:ignore FIELD_SAME_JSON_NAME
   *
   * @generated from field: ccbio.schemav1.Collection.Id id = 1;
   */
  id?: Collection_Id;

  /**
   * @generated from field: ccbio.schemav1.Collection.AccessControl access_control = 2;
   */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "ccbio.schemav1.Collection";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message ccbio.schemav1.Collection.Id
 */
export class Collection_Id extends Message<Collection_Id> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "ccbio.schemav1.Collection.Id";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message ccbio.schemav1.Collection.List
 */
export class Collection_List extends Message<Collection_List> {
  /**
   * @generated from field: repeated ccbio.schemav1.Collection items = 1;
   */
  items: Collection[] = [];
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "ccbio.schemav1.Collection.List";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message ccbio.schemav1.Collection.AccessControl
 */
export class Collection_AccessControl extends Message<Collection_AccessControl> {
   ...
   *
   *
   * @generated from field: ccbio.schemav1.Collection.AccessControl.AccessControlActions roles = 1;
   */
   ...
   *
   * @generated from field: ccbio.schemav1.Collection.AccessControl.AccessControlActions users = 2;
   */
   ...
   *
   * @generated from field: ccbio.schemav1.Collection.AccessControl.SpecimenActions specimen = 3;
   */
   ...
   *
   * @generated from field: ccbio.schemav1.Collection.AccessControl.SectionActions primary = 4;
   */
   ...
   *
   * @generated from field: ccbio.schemav1.Collection.AccessControl.SectionActions secondary = 5;
   */
   ...
   *
   * @generated from field: ccbio.schemav1.Collection.AccessControl.SectionActions taxon = 6;
   */
   ...
   *
   * @generated from field: ccbio.schemav1.Collection.AccessControl.SectionActions georeference = 7;
   */
   ...
   *
   * @generated from field: ccbio.schemav1.Collection.AccessControl.SectionActions images = 8;
   */
   ...
   *
   * @generated from field: ccbio.schemav1.Collection.AccessControl.SectionActions loans = 9;
   */
   ...
   *
   * @generated from field: ccbio.schemav1.Collection.AccessControl.SectionActions grants = 10;
   */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "ccbio.schemav1.Collection.AccessControl";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message ccbio.schemav1.Collection.AccessControl.AccessControlActions
 */
export class Collection_AccessControl_AccessControlActions extends Message<Collection_AccessControl_AccessControlActions> {
  /**
   * @generated from field: repeated ccbio.schemav1.Role view = 1;
   */
  view: Role[] = [];

  /**
   * @generated from field: repeated ccbio.schemav1.Role edit = 2;
   */
  edit: Role[] = [];
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "ccbio.schemav1.Collection.AccessControl.AccessControlActions";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message ccbio.schemav1.Collection.AccessControl.SpecimenActions
 */
export class Collection_AccessControl_SpecimenActions extends Message<Collection_AccessControl_SpecimenActions> {
  ...
  /**
   * @generated from field: repeated ccbio.schemav1.Role create = 2;
   */
  create: Role[] = [];

  /**
   * @generated from field: repeated ccbio.schemav1.Role delete = 3;
   */
  delete: Role[] = [];
   ...
   *
   * @generated from field: repeated ccbio.schemav1.Role hide_tx = 4;
   */
  hideTx: Role[] = [];
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "ccbio.schemav1.Collection.AccessControl.SpecimenActions";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "view", kind: "enum", T: proto3.getEnumType(Role), repeated: true },
...
/**
 * @generated from message ccbio.schemav1.Collection.AccessControl.SectionActions
 */
export class Collection_AccessControl_SectionActions extends Message<Collection_AccessControl_SectionActions> {
  ...
  /**
   * @generated from field: repeated ccbio.schemav1.Role suggest_edit = 3;
   */
  suggestEdit: Role[] = [];

  /**
   * @generated from field: repeated ccbio.schemav1.Role suggest_approve = 4;
   */
  suggestApprove: Role[] = [];

  /**
   * @generated from field: repeated ccbio.schemav1.Role suggest_reject = 5;
   */
  suggestReject: Role[] = [];
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "ccbio.schemav1.Collection.AccessControl.SectionActions";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "view", kind: "enum", T: proto3.getEnumType(Role), repeated: true },
    { no: 2, name: "edit", kind: "enum", T: proto3.getEnumType(Role), repeated: true },
...
/**
 * @generated from message ccbio.schemav1.CollectionList
 */
export class CollectionList extends Message<CollectionList> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "ccbio.schemav1.CollectionList";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "items", kind: "message", T: Collection, repeated: true },
  ]);
...
/**
 * @generated from message ccbio.schemav1.User
 */
export class User extends Message<User> {
  /**
   * @generated from field: ccbio.schemav1.User.Id id = 1;
   */
  id?: User_Id;
   ...
   *
   * @generated from field: map<string, ccbio.schemav1.Role> memberships = 5;
   */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "ccbio.schemav1.User";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 *
 * @generated from message ccbio.schemav1.User.Id
 */
export class User_Id extends Message<User_Id> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "ccbio.schemav1.User.Id";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message ccbio.schemav1.User.List
 */
export class User_List extends Message<User_List> {
  /**
   * @generated from field: repeated ccbio.schemav1.User items = 1;
   */
  items: User[] = [];
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "ccbio.schemav1.User.List";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message ccbio.schemav1.Specimen
 */
export class Specimen extends Message<Specimen> {
  /**
   * @generated from field: ccbio.schemav1.Specimen.Id id = 1;
   */
  id?: Specimen_Id;

  /**
   * @generated from field: ccbio.schemav1.Specimen.Primary primary = 3;
   */
  primary?: Specimen_Primary;

  /**
   * @generated from field: ccbio.schemav1.Specimen.Secondary secondary = 4;
   */
  secondary?: Specimen_Secondary;

  /**
   * @generated from field: ccbio.schemav1.Specimen.Taxon taxon = 5;
   */
  taxon?: Specimen_Taxon;

  /**
   * @generated from field: ccbio.schemav1.Specimen.Georeference georeference = 6;
   */
  georeference?: Specimen_Georeference;

  /**
   * @generated from field: map<string, ccbio.schemav1.Specimen.Image> images = 7;
   */
   ...
   *
   * @generated from field: map<string, ccbio.schemav1.Specimen.HiddenTx> hidden_txs = 10;
   */
  hiddenTxs: { [key: string]: Specimen_HiddenTx } = {};

  /**
   * @generated from field: ccbio.schemav1.LastModified last_modified = 20;
   */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "ccbio.schemav1.Specimen";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message ccbio.schemav1.Specimen.Id
 */
export class Specimen_Id extends Message<Specimen_Id> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "ccbio.schemav1.Specimen.Id";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "collection_id", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 2, name: "id", kind: "scalar", T: 9 /* ScalarType.STRING */ },
  ]);
...
/**
 * @generated from message ccbio.schemav1.Specimen.List
 */
export class Specimen_List extends Message<Specimen_List> {
  /**
   * @generated from field: repeated ccbio.schemav1.Specimen items = 1;
   */
  items: Specimen[] = [];
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "ccbio.schemav1.Specimen.List";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message ccbio.schemav1.Specimen.History
 */
export class Specimen_History extends Message<Specimen_History> {
  ...
  /**
   * @generated from field: repeated ccbio.schemav1.Specimen.History.Entry entries = 2;
   */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "ccbio.schemav1.Specimen.History";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "id", kind: "message", T: Specimen_Id },
...
/**
 * @generated from message ccbio.schemav1.Specimen.History.Entry
 */
export class Specimen_History_Entry extends Message<Specimen_History_Entry> {
  ...
  /**
   * @generated from field: ccbio.schemav1.Specimen state = 5;
   */
  state?: Specimen;
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "ccbio.schemav1.Specimen.History.Entry";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message ccbio.schemav1.Specimen.Primary
 */
export class Specimen_Primary extends Message<Specimen_Primary> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "ccbio.schemav1.Specimen.Primary";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message ccbio.schemav1.Specimen.Secondary
 */
export class Specimen_Secondary extends Message<Specimen_Secondary> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "ccbio.schemav1.Specimen.Secondary";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message ccbio.schemav1.Specimen.Taxon
 */
export class Specimen_Taxon extends Message<Specimen_Taxon> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "ccbio.schemav1.Specimen.Taxon";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message ccbio.schemav1.Specimen.Georeference
 */
export class Specimen_Georeference extends Message<Specimen_Georeference> {
  ...
  /**
   * @generated from field: ccbio.schemav1.LastModified last_modified = 10;
   */
  lastModified?: LastModified;
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "ccbio.schemav1.Specimen.Georeference";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 * Mapped Types
 *
 * @generated from message ccbio.schemav1.Specimen.Image
 */
export class Specimen_Image extends Message<Specimen_Image> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "ccbio.schemav1.Specimen.Image";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message ccbio.schemav1.Specimen.HiddenTx
 */
export class Specimen_HiddenTx extends Message<Specimen_HiddenTx> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "ccbio.schemav1.Specimen.HiddenTx";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "tx_id", kind: "scalar", T: 9 /* ScalarType.STRING */ },
...
/**
 * @generated from message ccbio.schemav1.SuggestedUpdate
 */
export class SuggestedUpdate extends Message<SuggestedUpdate> {
  /**
   * @generated from field: ccbio.schemav1.SuggestedUpdate.Id id = 1;
   */
  id?: SuggestedUpdate_Id;

  /**
   * @generated from field: ccbio.schemav1.User.Id suggested_by = 3;
   */
  suggestedBy?: User_Id;
  ...
  /**
   * @generated from field: ccbio.schemav1.Specimen.Primary primary = 6;
   */
  primary?: Specimen_Primary;

  /**
   * @generated from field: ccbio.schemav1.Specimen.Secondary secondary = 7;
   */
  secondary?: Specimen_Secondary;

  /**
   * @generated from field: ccbio.schemav1.Specimen.Taxon taxon = 8;
   */
  taxon?: Specimen_Taxon;

  /**
   * @generated from field: ccbio.schemav1.Specimen.Georeference georeference = 9;
   */
  georeference?: Specimen_Georeference;
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "ccbio.schemav1.SuggestedUpdate";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message ccbio.schemav1.SuggestedUpdate.Id
 */
export class SuggestedUpdate_Id extends Message<SuggestedUpdate_Id> {
  /**
   * @generated from field: ccbio.schemav1.Specimen.Id specimen_id = 1;
   */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "ccbio.schemav1.SuggestedUpdate.Id";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message ccbio.schemav1.SuggestedStateList
 */
export class SuggestedStateList extends Message<SuggestedStateList> {
  /**
   * @generated from field: repeated ccbio.schemav1.SuggestedUpdate items = 1;
   */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "ccbio.schemav1.SuggestedStateList";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
